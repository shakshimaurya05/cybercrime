...
export default function Initiative() {
  return (
    <section className="relative py-32 overflow-hidden">
      ...
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#0d0000] via-[#120000] to-[#050000]"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-white">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute inset-0 bg-red-600/20 blur-3xl opacity-40 group-hover:opacity-70 transition duration-500"></div>

            <img
              src={visionImg}
              alt="Cyber Vision"
              className="relative rounded-lg shadow-2xl border border-red-900 transform transition duration-500 group-hover:rotate-y-6 group-hover:scale-105"
            />
          </motion.div>
